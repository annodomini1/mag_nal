...
(cl:defmethod cl:initialize-instance :after ((m <Task>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taskgen3-msg:<Task> is deprecated: use taskgen3-msg:Task instead.")))

(cl:ensure-generic-function 'task_id-val :lambda-list '(m))
(cl:defmethod task_id-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen3-msg:task_id-val is deprecated.  Use taskgen3-msg:task_id instead.")
  (task_id m))

(cl:ensure-generic-function 'deadline-val :lambda-list '(m))
(cl:defmethod deadline-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen3-msg:deadline-val is deprecated.  Use taskgen3-msg:deadline instead.")
  (deadline m))

(cl:ensure-generic-function 'x_position-val :lambda-list '(m))
(cl:defmethod x_position-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen3-msg:x_position-val is deprecated.  Use taskgen3-msg:x_position instead.")
  (x_position m))

(cl:ensure-generic-function 'y_position-val :lambda-list '(m))
(cl:defmethod y_position-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen3-msg:y_position-val is deprecated.  Use taskgen3-msg:y_position instead.")
  (y_position m))

(cl:ensure-generic-function 'z_orientation-val :lambda-list '(m))
(cl:defmethod z_orientation-val ((m <Task>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen3-msg:z_orientation-val is deprecated.  Use taskgen3-msg:z_orientation instead.")
  (z_orientation m))
