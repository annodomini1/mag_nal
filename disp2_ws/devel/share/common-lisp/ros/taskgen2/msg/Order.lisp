...
(cl:defmethod cl:initialize-instance :after ((m <Order>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Order)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taskgen2-msg:<Order> is deprecated: use taskgen2-msg:Order instead.")))

(cl:ensure-generic-function 'deadline-val :lambda-list '(m))
(cl:defmethod deadline-val ((m <Order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen2-msg:deadline-val is deprecated.  Use taskgen2-msg:deadline instead.")
  (deadline m))

(cl:ensure-generic-function 'x_position-val :lambda-list '(m))
(cl:defmethod x_position-val ((m <Order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen2-msg:x_position-val is deprecated.  Use taskgen2-msg:x_position instead.")
  (x_position m))

(cl:ensure-generic-function 'y_position-val :lambda-list '(m))
(cl:defmethod y_position-val ((m <Order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen2-msg:y_position-val is deprecated.  Use taskgen2-msg:y_position instead.")
  (y_position m))

(cl:ensure-generic-function 'z_orientation-val :lambda-list '(m))
(cl:defmethod z_orientation-val ((m <Order>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader taskgen2-msg:z_orientation-val is deprecated.  Use taskgen2-msg:z_orientation instead.")
  (z_orientation m))
